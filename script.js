$(function () { //The fancier version of document.ready()
    ...
    function collision($div1, $div2) {
        var x1 = $div1.offset().left;//x axis
        var y1 = $div1.offset().top;//y axis
        var h1 = $div1.(true);
        var w1 = $div1.outerWidth(true);//passing true to return margin.
        var b1 = y1 + h1;
        var r1 = x1 + w1;
